        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center min-h-screen py-20 lg:py-24">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="mb-10 animate-fade-in-up">
              <img src={Logo} alt="PhysioMantra" className="h-14 sm:h-16 lg:h-18" />
            </div>
          ...
          <div className="order-1 lg:order-2 animate-slide-in-right stagger-2">
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-foreground/10 border border-border/50">
                <img 
                  src={HeroImage} 
